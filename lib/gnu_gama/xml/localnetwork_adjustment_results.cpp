...
void LocalNetworkAdjustmentResults::Parser::count_xyz(bool start)
{
    ...
    else
    {
        ...
        {
        case 1:
            adj->coordinates_summary.adjusted.xyz    = get_int();
            break;
        case 2:
            adj->coordinates_summary.constrained.xyz = get_int();
            break;
        case 3:
            adj->coordinates_summary.fixed.xyz       = get_int();
            break;
        default:
...
void LocalNetworkAdjustmentResults::Parser::count_xy(bool start)
{
    ...
    else
    {
        ...
        {
        case 1:
            adj->coordinates_summary.adjusted.xy    = get_int();
            break;
        case 2:
            adj->coordinates_summary.constrained.xy = get_int();
            break;
        case 3:
            adj->coordinates_summary.fixed.xy       = get_int();
            break;
        default:
            error("internal error");
        }
...
void LocalNetworkAdjustmentResults::Parser::count_z(bool start)
{
    ...
    else
    {
        ...
        {
        case 1:
            adj->coordinates_summary.adjusted.z    = get_int();
            break;
        case 2:
            adj->coordinates_summary.constrained.z = get_int();
            break;
        case 3:
            adj->coordinates_summary.fixed.z       = get_int();
            break;
        default:
            error("internal error");
        }
