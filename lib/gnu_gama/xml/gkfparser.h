...
public:
    ...
    {
        return direction_stdev_;
    }
    double implicit_stdev_angle()     const
    {
        return angle_stdev_;
    }
    double implicit_stdev_zangle()    const
    {
        return zenith_stdev_;
    }
    double implicit_stdev_azimuth()   const
    {
        return azimuth_stdev_;
    }
    ...
    double implicit_stdev_distance_a() const
    {
        return distance_stdev_;
    }
    double implicit_stdev_distance_b() const
    {
        return distance_stdev_km_;
    }
    double implicit_stdev_distance_c() const
    {
        return distance_stdev_exp_;
    }

    /* check if covariance matrices are positive-definite */
    void   check_covariances(bool ch=true)
    {
        check_cov_mat = ch;
    }
