...
int GKFparser::startElement(const char *cname, const char **atts)
{
    ...
    case state_network:
        ...
        case tag_parameters         :
            return process_parameters(atts);
        case tag_points_observations:
            return process_point_obs(atts);
        default:
    ...
    case state_point_obs:
        ...
        {
        case tag_point             :
            return process_point(atts);
        case tag_obs               :
            return process_obs(atts);
        case tag_coordinates       :
            return process_coords(atts);
        case tag_height_differences:
            return process_hdiffs(atts);
        case tag_vectors           :
            return process_vectors(atts);
        default:
            return error(T_GKF_e01a_illegal_tag + string(cname) +
    ...
    case state_obs:
        ...
        {
        case tag_direction :
            return process_direction(atts);
        case tag_distance  :
            return process_distance(atts);
        case tag_angle     :
            return process_angle(atts);
        case tag_s_distance:
            return process_sdistance(atts);
        case tag_z_angle   :
            return process_zangle(atts);
        case tag_dh        :
            return process_obs_dh(atts);
        case tag_azimuth   :
            return process_azimuth(atts);
        case tag_cov_mat   :
            return process_obs_cov(atts);
        default:
            return error(T_GKF_e01a_illegal_tag + string(cname) +
    ...
    case state_coords:
        ...
        {
        case tag_point  :
            return process_coords_point(atts);
        case tag_cov_mat:
            return process_coords_cov(atts);
        default:
            return error(T_GKF_e01a_illegal_tag + string(cname) +
    ...
    case state_hdiffs:
        ...
        {
        case tag_dh     :
            return process_dh(atts);
        case tag_cov_mat:
            return process_hdiffs_cov(atts);
        default:
            return error(T_GKF_e01a_illegal_tag + string(cname)  +
    ...
    case state_vectors:
        ...
        {
        case tag_vec    :
            return process_vec(atts);
        case tag_cov_mat:
            return process_vectors_cov(atts);
        default:
            return error(T_GKF_e01a_illegal_tag + string(cname) + ">");
        }
...
int GKFparser::process_angle(const char** atts)
{
    ...
    if (GNU_gama::deg2gon(sm, dm))
        degrees = true;
    else if (!toDouble(sm, dm)) return error(T_GKF_bad_angle + sm);
...
int GKFparser::process_zangle(const char** atts)
{
    ...
    if (GNU_gama::deg2gon(sm, dm))
        degrees = true;
    else if (!toDouble(sm, dm)) return error(T_GKF_bad_zangle + sm);
...
int GKFparser::process_direction(const char** atts)
{
    ...
    if (GNU_gama::deg2gon(sm, dm))
        degrees = true;
    else if (!toDouble(sm, dm)) return error(T_GKF_bad_direction + sm);
...
int GKFparser::process_azimuth(const char** atts)
{
    ...
    if (GNU_gama::deg2gon(sm, dm))
        degrees = true;
    else if (!toDouble(sm, dm)) return error(T_GKF_bad_azimuth + sm);
