...
public:
    ...
    PointID     unknown_pointid   (int i) const
    {
        return seznez_[i-1].cb;
    }
    char        unknown_type      (int i) const
    {
        return seznez_[i-1].typ;
    }
    StandPoint* unknown_standpoint(int i) const
    {
        return seznez_[i-1].osn;
    }
    ...
    Double m_0();
    Double apriori_m_0() const
    {
        return m_0_apr_;
    }

    Double qxx(Index i, Index j)
    {
        return least_squares->q_xx(i,j);
    }
    Double qbb(Index i, Index j)
    {
        return least_squares->q_bb(i,j);
    }
    Double qbx(Index i, Index j)
    {
        return least_squares->q_bx(i,j);
    }
    ...
    void   apriori_m_0(Double m)
    {
        m_0_apr_ = m;
    }
    void   tol_abs(Double m)
    {
        tol_abs_ = m;
    }
    ...
    Double stdev_obs(int i)
    {
        return sigma_L(i);
    }
    Double wcoef_res(int i)
    {
        return vahkopr(i);
    }
    ...
    bool m_0_apriori    () const
    {
        return typ_m_0_ == apriorni_;
    }
    bool m_0_aposteriori() const
    {
        return typ_m_0_ == empiricka_;
    }
    Double m_0_aposteriori_value();

    void set_m_0_apriori    ()
    {
        typ_m_0_ = apriorni_;
    }
    void set_m_0_aposteriori()
    {
        typ_m_0_ = empiricka_;
    }

    Double conf_pr() const
    {
        return konf_pr_;
    }
    ...
    int maxw_id () const
    {
        return 12;    // max width of point id.
    }
    int maxw_unk() const
    {
        return  3;    // max width of index of unknown
    }
    int maxw_obs() const
    {
        return  4;    // max width of index of observation
    }
    ...
    {
        gons_ = true;
        Observation::gons = true;
    }
    void set_degrees()
    {
        gons_ = false;
        Observation::gons = false;
    }

    // ...  connected network  .............................................

    bool connected_network() const
    {
        return design_matrix_graph_is_connected;
    }
