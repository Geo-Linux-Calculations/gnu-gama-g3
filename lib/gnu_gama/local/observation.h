...
public:
    ...
    const PointID& from() const
    {
        return from_;
    }
    const PointID& to()   const
    {
        return to_;
    }
    Double value()        const
    ...
    void    set_from_dh(Double h)
    {
        from_dh_ = h;
    }
    void    set_to_dh  (Double h)
    {
        to_dh_   = h;
    }
...
public:
    ...
    const PointID& bs() const
    {
        return to();    // backsight station
    }
    const PointID& fs() const
    {
        return fs_;     // foresight station
    }
...
public:
    ...
    CLONE(H_Diff*) clone() const
    {
        return new H_Diff(*this);
    }
...
public:
    ...
    CLONE(Xdiff*) clone() const
    {
        return new Xdiff(*this);
    }
};
...
public:
    ...
    CLONE(Ydiff*) clone() const
    {
        return new Ydiff(*this);
    }
};
...
public:
    ...
    CLONE(Zdiff*) clone() const
    {
        return new Zdiff(*this);
    }
};
...
public:
    ...
    CLONE(S_Distance*) clone() const
    {
        return new S_Distance(*this);
    }
};
...
public:
    ...
    CLONE(Z_Angle*) clone() const
    {
        return new Z_Angle(*this);
    }
...
public:
    ...
    CLONE(Azimuth*) clone() const
    {
        return new Azimuth(*this);
    }
